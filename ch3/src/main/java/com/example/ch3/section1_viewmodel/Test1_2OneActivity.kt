...
// ViewModel 객체는 Activity Scope 내에서 싱글톤
// 여러 Actiity 가 동일 ViewModel 을 이용하면 Activity 단위로 객체 생성
class Test1_2OneActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.button2.setOnClickListener {
            Toast.makeText(this, "one: $activityCount, ${viewModel.count}", Toast.LENGTH_SHORT)
                .show()
        }
